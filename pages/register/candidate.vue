<template>
<div class="">
    <v-row class="container" style="background-color:  #1A1B2B;">
                    ...
                    <v-col>
                        ...
                        <div class="container">
                            ...
                            <form @submit.prevent="submitCandidate">
                                ...
                                <v-text-field v-model="form.dob" placeholder="Date of Birth" type="date" outlined rounded @change="calculateAge" />
        ...
        <v-col cols="12" md="6" lg="6">
            ...
            <div class="container">
                <v-img :src="can" contain style="margin: 180px;" />
            </div>
