...
export default {
    ...
    methods: {
        async fetchCandidates() {
            ...
            this.loading = true;
            try {
                const res = await axios.get(`https://yayalinkserver-production-b920.up.railway.app/api/candidates/get-candidate/${this.$route.params.id}`, {});
        ...
        async fetchBureau() {
            ...
            this.loading = true;
            try {
                const res = await axios.get(`https://yayalinkserver-production-b920.up.railway.app/api/bureaus/get-bureau/${this.uid}`, {});
        ...
        async submitCandidate() {
            ...
            if (this.form.age === "") {
                ...
                try {
                    await axios.post("https://yayalinkserver-production-b920.up.railway.app/api/candidates/register", this.form);
